...
export default function AgentClaimsPage() {
    ...
    // Mock data based on the new Claim type (Agent filtered)
    ...
    const handleRejectHandled = (claimId: string) => {
        ...
        toast.success("ריג'קט טופל בהצלחה", {
            description: "המשימה הועברה בחזרה לצוות תפעול להמשך עבודה מול חברת הביטוח"
        });
    };
            ...
            <div className="space-y-6" dir="rtl">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-black text-amber-100 flex items-center gap-3">
                            ...
                            ניהול תביעות - הלקוחות שלי
                        </h1>
                        <p className="text-slate-400 mt-1">ניהול ומעקב אחר תביעות הלקוחות שלך</p>
                    </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        { label: 'תביעות שאושרו', value: claims.filter(c => ['approved', 'paid'].includes(c.status)).length, color: 'emerald' },
                                                    ...
                                                    <div className="flex justify-between items-center mb-4">
                                                        ...
                                                        <div className="flex gap-2">
                                                            {claim.workflowStatus === 'waiting_for_agent' && (
                                                                <Button 
                                                                    size="sm" 
                                                                    className="h-8 bg-emerald-500 hover:bg-emerald-600 text-slate-900"
                                                            ...
                                                            <Button size="sm" variant="outline" className="h-8 border-slate-600">
                                                                <Plus size={14} className="ml-1" />
                                                                העלאת מסמך
                                                            </Button>
                                                        </div>
