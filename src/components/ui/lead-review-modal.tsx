...
import { type ClientProfile } from "@/lib/services/analysis-service";
                ...
                <div className="p-8 space-y-6 overflow-y-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            />
                            {errors.name ? <p className="text-xs text-red-500 font-bold">{errors.name}</p> : null}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                dir="ltr"
                            />
                            {errors.phone ? <p className="text-xs text-red-500 font-bold">{errors.phone}</p> : null}
                        </div>
