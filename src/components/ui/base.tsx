    ...
    return (
        <div className={`${variantStyles[variant]} rounded-3xl p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 ${className}`} {...props}>
            {title ? <h3 className="mb-4 text-lg font-black text-amber-100 flex items-center gap-2">
                    <div className="h-1.5 w-4 bg-linear-to-r from-amber-500 to-blue-500 rounded-full" />
                    {title}
                </h3> : null}
            {children}
        </div>
...
export const Button = memo(function Button({
    ...
    const variants = {
        primary: "bg-linear-to-r from-slate-800 to-slate-900 text-amber-100 shadow-lg shadow-black/30 hover:shadow-xl hover:shadow-amber-500/20 rounded-2xl border border-amber-500/20 hover:border-amber-500/40",
        secondary: "bg-linear-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 rounded-2xl",
        ...
        gold: "bg-linear-to-r from-amber-500 via-amber-400 to-amber-500 text-slate-900 shadow-lg shadow-amber-500/40 hover:shadow-xl hover:shadow-amber-500/50 rounded-2xl font-black",
        blue: "bg-linear-to-r from-blue-600 via-blue-500 to-blue-600 text-white shadow-lg shadow-blue-500/40 hover:shadow-xl hover:shadow-blue-500/50 rounded-2xl font-black",
        premium: "bg-linear-to-r from-amber-500 via-amber-400 to-blue-500 text-slate-900 shadow-lg shadow-amber-500/30 hover:shadow-xl rounded-2xl font-black"
    };
